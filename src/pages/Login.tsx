                ...
                <div className="form-wrapper">
                    ...
                    <form onSubmit={handleLogin} className="login-form">
                        ...
                        <div className="form-actions">
                            <Link to="/forgot-password" title="Recuperar senha de acesso" className="forgot-password">Esqueceu a senha?</Link>
                        </div>
                    ...
                    <div className="form-footer">
                        <p className="text-small">
                            Ainda não tem acesso? <a href="https://wa.me/5511999999999?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20a%20Consultoria%20YF" target="_blank" rel="noopener noreferrer" className="link">Entre em contato</a>
                        </p>
                    </div>
                </div>
            </div>
